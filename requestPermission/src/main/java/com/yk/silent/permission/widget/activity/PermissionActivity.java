package com.yk.silent.permission.widget.activity;
...
import com.yk.silent.permission.widget.adapter.PermissionAdapter;
import com.yk.silent.permission.widget.ui.PermissionView;
import com.yk.silent.permission.R;
import com.yk.silent.permission.impl.ConstantValue;
...
public class PermissionActivity extends AppCompatActivity {
    ...
    private void showPermissionDialog() {
        ...
        String msg = TextUtils.isEmpty(mMsg) ?
                String.format(getString(R.string.permission_dialog_msg), mAppName) : mMsg;
